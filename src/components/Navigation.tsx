        ...
        <div className="container mx-auto px-6 md:px-12 flex justify-between items-center">
          <Link href="/" className="group relative z-50">
            <div className={clsx(
              ...
              <Image src="/logo_no_slogan.png" alt="Flint & Copper" width={500} height={160} className="h-10 md:h-12 w-auto object-contain scale-[1.15] md:scale-[1.25] origin-left -translate-y-0.5 md:-translate-y-1" priority />
            </div>
          </Link>
